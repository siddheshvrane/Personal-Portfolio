            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <form className="bg-white border-4 border-black p-8 shadow-brutal-lg max-w-2xl mx-auto text-left">
                    <div className="mb-6">
                        ...
                        <input type="text" className="w-full bg-gray-100 border-2 border-black p-4 font-mono focus:outline-none focus:bg-neon-lime focus:border-black transition-colors" placeholder="Alfredo Linguini" />
                    </div>
                    <div className="mb-6">
                        <label className="block font-mono font-bold mb-2 uppercase">Email Address</label>
                        <input type="email" className="w-full bg-gray-100 border-2 border-black p-4 font-mono focus:outline-none focus:bg-neon-lime focus:border-black transition-colors" placeholder="alfredo_linguini@domain.com" />
                    </div>
                    <div className="mb-8">
                        <label className="block font-mono font-bold mb-2 uppercase">Message</label>
                        <textarea rows="4" className="w-full bg-gray-100 border-2 border-black p-4 font-mono focus:outline-none focus:bg-neon-lime focus:border-black transition-colors" placeholder="Tell me your wildest ideas..."></textarea>
                    </div>
